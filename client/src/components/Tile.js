...
export default function Tile({id, reminder, description, dateTime, removeTile, convertDT, setDetails, setModal, timeRemaining}) {
  ...
  return (
    <div className="tile" name={"t" + id}>
      ...
      <div className="tile-content" onClick={details}>
        ...
        <h3 className="tile-datetime" name={"dt" + id}>{convertDT(dateTime)}</h3>
